...
function Alpha() {
  return (
    <div className='w-full h-screen bg-gradient-to-r from-sky-300 via-fuchsia-100 to-pink-300 overflow-auto '>
      ...
      <div className='flex flex-row'><img className='pl-20 m-1' src={nobi} />
        <div className='pl-3 text-2xl pr-10 pt-10'>野比大野比（野比のび太，野比大雄）是由藤尾藤子創作的哆啦A夢動畫和漫畫系列中的虛構人物，藤本浩和元尾我子的筆名。在動畫的一些英文當地語系化中，Nobita被稱為Sidney，Specky和Nobi Nobi Nobi，通常被描繪成東京練馬區的一名學術小學生，也是Nobisuke和Tamako Nobi的唯一孩子，他永遠由該系列的標題角色照顧，這是一隻由Nobita的後代送回過去的機器貓。
          與哆啦A夢一樣，大雄被認為是最受歡迎和廣泛認可的漫畫人物之一，因為該系列的受歡迎程度超出了其本土日本。
        </div>
      </div>
      <div className='m-10 pl-10 flex border-b-2 pb-2'>
        <div className=' font-bold text-5xl'>特性</div>
      </div>
      <p className='pl-10 pr-10 text-xl tracking-wider pb-10'>野比大野比（野比のび太，野比大雄）是由藤尾藤子創作的哆啦A夢動畫和漫畫系列中的虛構人物，藤本浩和元尾我子的筆名。在動畫的一些英文當地語系化中，Nobita被稱為Sidney，Specky和Nobi Nobi Nobi，通常被描繪成東京練馬區的一名學術小學生，也是Nobisuke和Tamako Nobi的唯一孩子，他永遠由該系列的標題角色照顧，這是一隻由Nobita的後代送回過去的機器貓。
        與哆啦A夢一樣，大雄被認為是最受歡迎和廣泛認可的漫畫人物之一，因為該系列的受歡迎程度超出了其本土日本。
      </p>
      <div className='m-10 pl-10 flex border-b-2 pb-2'>
        <div className=' font-bold text-5xl'>优点</div>
      </div>
      <p className='pl-10 pr-10 text-xl tracking-wider pb-10'>心地本为善良，并乐于助人，且对动植物和玩具都很有同情心（也有例外），也曾愿意放弃自己的礼物，换取别人快乐[12]，有时更会请求哆啦A梦用道具帮助他人。
      ...
      <p className='pl-10 pr-10 text-xl tracking-wider pb-10'>
...
function Beta() {
  return (
    <div className='w-full h-screen bg-gradient-to-r from-sky-300 via-fuchsia-100 to-pink-300 overflow-auto '>
      <Link to="/"> <button className=' m-7'><Icon icon="line-md:arrow-left-circle" width="50" height="50" /></button></Link>
      <div className='flex flex-row'><img className='pl-20 m-1 rounded-xl' src={jingxiang1} />
        <div className='pl-3 text-2xl pr-10 pt-10'>源静香通称静香，旧译陈静香、静怡、静儿、静子、宜静、静静、小静等，是藤子·F·不二雄漫画和动画作品《哆啦A梦》中的女主角。
        </div>
      </div>
      <div className='m-10 pl-10 flex border-b-2 pb-2'>
...
function Gamma() {
  return (
    <div className='w-full h-screen bg-gradient-to-r from-sky-300 via-fuchsia-100 to-pink-300 overflow-auto '>
      <Link to="/"> <button className=' m-7'><Icon icon="line-md:arrow-left-circle" width="50" height="50" /></button></Link>
      <div className='flex flex-row'><img className='pl-20 m-1 w-80 h-50' src={doraemon3} />
        <div className='pl-3 text-2xl pr-10 pt-10'>哆啦A梦为了帮助大雄，经常从他的四次元口袋里拿出来自未来世界的道具，而“法宝”在香港和台湾等地是通用语。“ 法宝”这个用语，早在香港1973年连载当初已经出现，到今天的主题曲歌词、漫画、电视动画及电影也普遍使用“法寶”；台湾动画版也使用“法寶”，早期电影版亦曾译为“工具”，台湾水田版动画则译“秘密道具”。各种道具的创意和科幻想像成为哆啦A梦的特色之一。截至2004年5月为止，最权威的统计是漫画版的哆啦A梦共有1963个道具（横山泰行教授统计），但若含动画版出现的道具则总数超过2200个。
        </div>
      </div>
      <div className='m-10 pl-10 flex border-b-2 pb-2'>
        <div className=' font-bold text-5xl'>性格</div>
      </div>
      <p className='pl-10 pr-10 text-xl tracking-wider pb-10'>基本还算温和的性格。但是由于它的职务是看管小孩，因此变得有些好管闲事。
        尽管它自己经常劝告大雄慎用道具，但因为它本人的过失导致事态扩大的情况也不在少数。当惊慌的时候就会完全失去理智，经常拿错道具。有时也会不考虑别人的感受，做出惹怒对方的事情。当大雄不争气的时候，也经常会训斥大雄。
      </p>
      <div className='m-10 pl-10 flex border-b-2 pb-2'>
        <div className=' font-bold text-5xl'>优点</div>
      </div>
      <p className='pl-10 pr-10 text-3xl tracking-wider pb-10'>
        心肠好，乐于助人
      </p>
      <div className='m-10 pl-10 flex border-b-2 pb-2'>
        <div className=' font-bold text-5xl'>缺点</div>
      </div>
      <p className='pl-10 pr-10 text-2xl tracking-wider pb-10'>
...
function Delta() {
  return (
    <div className='w-full h-screen bg-gradient-to-r from-sky-300 via-fuchsia-100 to-pink-300 overflow-auto '>
      <Link to="/"> <button className=' m-7'><Icon icon="line-md:arrow-left-circle" width="50" height="50" /></button></Link>
      <div className='flex flex-row'><img className='pl-20 m-1' src={xiaofu2} />
        <div className='pl-3 text-2xl pr-10 pt-10'>旧译阿福、骨川阿福、王小夫，在大雄、胖虎和静香四人中最年长也最矮。他在四人中家境最富有（父亲是公司社长），最爱称赞自己。
        </div>
      </div>
      <div className='m-10 pl-10 flex border-b-2 pb-2'>
        <div className=' font-bold text-5xl'>性格</div>
      </div>
      <p className='pl-10 pr-10 text-xl tracking-wider pb-10'>用家庭财力来搜集自己喜欢的东西，让别人非常嫉妒。而导致大雄去请求哆啦A梦拿出道具。很臭美，可以持续照镜子30分钟”。经常以胖虎参谋的角色来欺负大雄有时也用哆啦A梦的道具来恶作剧。亦经常识破大雄的恶作剧与道具的秘密，经常与胖虎或自己从大雄手上抢夺或偷取哆啦A梦的道具使用，不过却会自食其果。嘴巴非常善于奉承，有为了得到好处或推卸责任说谎的习惯，经常旅行，又喜欢吹嘘炫耀有写日记习惯，但是都是写自己很漂亮等的话。
      </p>
      <div className='m-10 pl-10 flex border-b-2 pb-2'>
        <div className=' font-bold text-5xl'>优点</div>
      </div>
...
function Zeta() {
  return (
    <div className='w-full h-screen bg-gradient-to-r from-sky-300 via-fuchsia-100 to-pink-300 overflow-auto '>
      <Link to="/"> <button className=' m-7'><Icon icon="line-md:arrow-left-circle" width="50" height="50" /></button></Link>
      <div className='flex flex-row'><img className='pl-20 m-1' src={panghu2} />
        <div className='pl-3 text-2xl pr-10 pt-10'>刚田武为本名，其绰号为日版对巨人的片假名读法，旧译技安、武胖虎、武技安。中文版早期译名“技安”即出自这个绰号的音译，而现今中文翻译使用的“胖虎”
          與哆啦A夢一樣，大雄被認為是最受歡迎和廣泛認可的漫畫人物之一，因為該系列的受歡迎程度超出了其本土日本。
        </div>
      </div>
      <div className='m-10 pl-10 flex border-b-2 pb-2'>
...
function Eta() {
  return (
    <div className='w-full h-screen bg-gradient-to-r from-sky-300 via-fuchsia-100 to-pink-300 overflow-auto '>
      <Link to="/"> <button className=' m-7'><Icon icon="line-md:arrow-left-circle" width="50" height="50" /></button></Link>
      <div className='flex flex-row'><img className='pl-20 m-1' src={ahboy2} />
        <div className='pl-3 text-2xl pr-10 pt-10'>
      ...
      <p className='pl-10 pr-10 text-xl tracking-wider pb-10'>各方面的完美，个性谦和、待人和善与正直，头脑聪明，知识丰富好学，体育也擅长。
      </p>
      <div className='m-10 pl-10 flex border-b-2 pb-2'>
        <div className=' font-bold text-5xl'>优点</div>
      </div>
      <p className='pl-10 pr-10 text-xl tracking-wider pb-10'>他不但读书了得，性格善良，也是一个运动健将。因此，他在人际关系、学业成绩、体育、甚至演戏方面也是一等一的天才高手，更深得女同学的欢迎。 可是他却因为特别出众而经常招来大雄、小夫、胖虎等男同学的妒忌。
      </p>
      <div className='m-10 pl-10 flex border-b-2 pb-2'>
        <div className=' font-bold text-5xl'>缺点</div>
      </div>
